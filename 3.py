    ...
    try:
        ...
        if not championships:
            messagebox.showwarning(
                "تنبيه",
                "لم يتم العثور على مباريات أو تغير هيكل الموقع."
            )
            return
            ...
            for match in matches:
                ...
                try:
                    ...
                    if result_div:
                        ...
                        if len(scores) >= 2:
                            score = (
                                f"{scores[0].text.strip()} - "
                                f"{scores[1].text.strip()}"
                            )

                        time_tag = result_div.find(
                            "span",
                            class_="time"
                        )
        ...
        if messagebox.askyesno(
            "حفظ النتائج",
            "هل ترغب في حفظ النتائج في ملف CSV ؟"
        ):
                ...
                if file_name:
                    ...
                    with open(
                        ...
                        writer = csv.DictWriter(
                            file,
                            fieldnames=matches_details[0].keys()
                        )
        ...
        messagebox.showerror(
            "انتهاء المهلة",
            "استغرق الموقع وقتاً طويلاً في الاستجابة."
        )
